...
public class DelayedExecutor {
	...
	public static <V> Future<V> run(CallableWithId<V,?> callable, long time, TimeUnit timeUnit) {
	...
	public static void main(String[] args) {
        ...
        Future<Boolean> future = DelayedExecutor.run(callable, 2, TimeUnit.SECONDS );
        //DelayedExecutor.cancel(callable );
        future.cancel(true);
       // System.out.println("Size in DelayedExecutor.futures==" + DelayedExecutor.futures.size() );
